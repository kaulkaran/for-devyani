...
const songs: Song[] = [
  ...
  },
  {
    ...
    comment: `Devyani, suna hai aashiq uska
shayar nahi hai.....❤️,
...
Ki aage khada hai koi baaho me araam karane ko 🌹`
  ...
  Wo ladki jis din mere seher aayegi`
    ...
    comment: "Devyani, if our story had a soundtrack, this would be one of the highlights. 🎶"
    },
    {
    id: 11,
    title: "Laal Ishq",
  ...
  comment: "This song paints a picture of love, but you make it come alive for me."
    ...
    Chahoon rehna sada`,
    comment: "Devyani, every time I hear this, I can’t help but think of us dancing under the stars."
    },
  {
    id: 14,
...
comment: "A moving song filled with emotional depth."
    ...
    comment: "Devyani, this reminds me of all the little moments we’ve shared that make life so beautiful."
    },
    {
    id: 24,
    title: "Purani Tape",
    ...
    <footer className="bg-white/10 backdrop-blur-lg text-white py-6 mt-12">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-purple-200 text-sm mt-1">
          Dedicated to the love of <span className="text-pink-300 font-semibold">Devyani</span>
        </p>
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-4 text-center">
          <div className="space-y-8">
            <h1 className="text-6xl font-bold text-white mb-4">
              ...
              <span className="block text-pink-300 mt-2">Devyani ❤️</span>
            </h1>
